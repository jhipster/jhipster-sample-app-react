...
describe('Label e2e test', () => {
  ...
  const labelSample = { label: 'nervously uh-huh' };
  ...
  describe('new Label page', () => {
    ...
    it('should create an instance of Label', () => {
      cy.get(`[data-cy="label"]`).type('quizzical selfishly huzzah');
      cy.get(`[data-cy="label"]`).should('have.value', 'quizzical selfishly huzzah');
