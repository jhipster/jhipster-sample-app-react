...
describe('BankAccount e2e test', () => {
  ...
  const bankAccountSample = { name: 'monitor Computer', balance: 46986 };
  ...
  describe('new BankAccount page', () => {
    ...
    it('should create an instance of BankAccount', () => {
      cy.get(`[data-cy="name"]`).type('white');
      cy.get(`[data-cy="name"]`).should('have.value', 'white');

      cy.get(`[data-cy="balance"]`).type('55411');
      cy.get(`[data-cy="balance"]`).should('have.value', '55411');
