...
describe('BankAccount e2e test', () => {
  ...
  const bankAccountSample = { name: 'monitor Computer', balance: 15396 };
  ...
  describe('new BankAccount page', () => {
    ...
    it('should create an instance of BankAccount', () => {
      cy.get(`[data-cy="name"]`).type('Diesel');
      cy.get(`[data-cy="name"]`).should('have.value', 'Diesel');

      cy.get(`[data-cy="balance"]`).type('18157');
      cy.get(`[data-cy="balance"]`).should('have.value', '18157');
