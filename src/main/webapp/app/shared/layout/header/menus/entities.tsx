...
export const EntitiesMenu = props => (
  ...
  <NavDropdown icon="th-list" name={translate('global.menu.entities.main')} id="entity-menu">
    ...
    <DropdownItem tag={Link} to="/entity/label">
      <FontAwesomeIcon icon="asterisk" />&nbsp;<Translate contentKey="global.menu.entities.label" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/operation">
      <FontAwesomeIcon icon="asterisk" />&nbsp;<Translate contentKey="global.menu.entities.operation" />
    </DropdownItem>
