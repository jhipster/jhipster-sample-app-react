...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './label.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LABEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LABEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches PARTIAL_UPDATE_LABEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LABEL actions', async () => {
      const arg = 42666;
