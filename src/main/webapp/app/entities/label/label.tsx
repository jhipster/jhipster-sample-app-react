...
export class Label extends React.Component<ILabelProps> {
  ...
  render() {
    const { labelList, match } = this.props;
    return (
      <div>
        <h2 id="label-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationReactApp.label.home.createLabel">Create a new Label</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {labelList && labelList.length > 0 ? (
            <Table responsive aria-describedby="label-heading">
              <thead>
                <tr>
                  <th>
