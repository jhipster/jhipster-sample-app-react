...
export class BankAccount extends React.Component<IBankAccountProps> {
  componentDidMount() {
      ...
      <div>
        <h2 id="bank-account-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationReactApp.bankAccount.home.createLabel">Create a new Bank Account</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {bankAccountList && bankAccountList.length > 0 ? (
            <Table responsive aria-describedby="bank-account-heading">
              <thead>
                <tr>
                  <th>
